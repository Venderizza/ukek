<template>
  <div class="w-auto mt-8 md:mt-20 flex flex-col items-center justify-center">
    ...
    <div class="flex gap-3 justify-center">
      ...
      <div class="text-lg md:text-xl text-primary-lightbrown text-center">Задай свой вопрос волонтёру Юре</div>
    ...
    <div class="w-full lg:w-4xl my-10">
      <Keyboard @onChange="onChange" @onKeyPress="onKeyPress" :input="quetion"/>
    </div>
...
const onInputChange = (event) => {
  resizeTextarea();
  quetion.value = event.target.value;
};
